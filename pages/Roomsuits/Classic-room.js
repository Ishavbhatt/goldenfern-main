...
function ClassicRoom() {
    ...
    return (
        <>
          ...
          <meta property="og:description" content="Classic rooms are designed to the finest standards and are located on all levels, with all modern amenities and furnishing to meet desired | Golden Fern Resort" />              
          </Head> 
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-5 col-md-5 col-sm-12 about_hotel_text">
                ...
                <h2 className="common_title"><span className="golden_color">Classic </span>Room 
                </h2>
