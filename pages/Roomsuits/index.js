...
<div id="sidebar" className="list-group room_suit_left">
	<li >
  <Link className="list-group-item list-group-item-action " href="/Roomsuits#room1">EXECUTIVE ROOM</Link> </li>
  <li className=""><Link className="list-group-item list-group-item-action" href="/Roomsuits#room2">CLASSIC ROOM</Link></li>
 <li className=""> <Link className="list-group-item list-group-item-action" href="/Roomsuits#room3">LUXURY ROOM</Link></li>
  <li className=""><Link className="list-group-item list-group-item-action" href="/Roomsuits#room4">DELUXE ROOM</Link></li>
</div>
</div>
...
<div className="scrollspy-example col-md-10 offset-md-2" tabIndex="0">
 ...
 <div className="col-lg-7 col-md-7 col-sm-12 about_hotel_right text-center">
              ...
              <div className="col-lg-5 col-md-5 col-sm-12 about_hotel_text">
                <h2 className="common_title"><span className="golden_color">EXECUTIVE</span>ROOM</h2>
                <p>Designed to the highest specifications and situated on all floors, with a private balcony and city view the executive rooms are spacious with all modern amenities and furnishing to meet the desired level of the satisfaction of the esteemed guests at Golden Fern Resort Shimla.</p>
                <a className="common_arrow" href="/Roomsuits/Executive-room"><img src="/arrow.svg" alt="Icon"/></a>
              </div>
 ...
 <div className="col-lg-7 col-md-7 col-sm-12 about_hotel_right text-center">
              ...
              <div className="col-lg-5 col-md-5 col-sm-12 about_hotel_text">
                <h2 className="common_title"><span className="golden_color">CLASSIC</span>ROOM</h2>
                <p>Designed to the highest specifications and situated on all floors, with a private balcony and city view the executive rooms are spacious with all modern amenities and furnishing to meet the desired level of the satisfaction of the esteemed guests at Golden Fern Resort Shimla.</p>
                <a className="common_arrow" href="/Roomsuits/Classic-room"><img src="/arrow.svg" alt="Icon"/></a>
              </div>
 ...
 <div className="col-lg-7 col-md-7 col-sm-12 about_hotel_right text-center">
              ...
              <div className="col-lg-5 col-md-5 col-sm-12 about_hotel_text">
                <h2 className="common_title"><span className="golden_color">LUXURY</span>ROOM</h2>
                <p>Designed to the highest specifications and situated on all floors, with a private balcony and city view the executive rooms are spacious with all modern amenities and furnishing to meet the desired level of the satisfaction of the esteemed guests at Golden Fern Resort Shimla.</p>
                <a className="common_arrow" href="/Roomsuits/Luxury-room"><img src="images/arrow.svg" alt="Icon"/></a>
              </div>
 ...
 <div className="col-lg-7 col-md-7 col-sm-12 about_hotel_right text-center">
              ...
              <div className="col-lg-5 col-md-5 col-sm-12 about_hotel_text">
                <h2 className="common_title"><span className="golden_color">DELUXE</span>ROOM</h2>
                <p>Designed to the highest specifications and situated on all floors, with a private balcony and city view the executive rooms are spacious with all modern amenities and furnishing to meet the desired level of the satisfaction of the esteemed guests at Golden Fern Resort Shimla.</p>
                <a className="common_arrow" href="/Roomsuits/Deluxe-room"><img src="images/arrow.svg" alt="Icon"/></a>
              </div>
